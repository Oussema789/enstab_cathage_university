...
final imgListAnimals = generateImageList(
  'etc/visites/animal_shelter',
  5,
  'etc_',
);

final imgListTrees = generateImageList(
  'nateg/voluntary',
  5,
  'nateg_',
);
final imgListChildren = generateImageList(
  'electronix/workshops/visites',
  11,
  'electronix_',
);
